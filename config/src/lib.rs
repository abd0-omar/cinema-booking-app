//! The cinema-booking-config crate contains functionality for parsing as well as accessing the project's documentation.
...
pub struct DatabaseConfig {
    /// The URL to use to connect to the database, e.g. "sqlite:./data/database.sqlite?mode=rwc"
    pub url: String,
}
...
mod tests {
    ...
    fn test_load_config_development() {
        figment::Jail::expect_with(|jail| {
            ...
            jail.set_env(
                "APP_DATABASE__URL",
                "sqlite:./data/cinema_booking.sqlite?mode=rwc",
            );
            ...
            assert_that!(
                ...
                eq(&Config {
                    ...
                    database: DatabaseConfig {
                        url: String::from("sqlite:./data/cinema_booking.sqlite?mode=rwc"),
                    },
